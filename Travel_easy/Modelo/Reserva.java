...
public class Reserva {
	private int codigo_reserva;
	 // NOMBRE DE LA PERSONA QUE REALIZO LA RESERVA
	...
	public Reserva(int codigo_reserva, double precio_total, Paquete paquete,
	...
	public String toString() {
		return "Reserva [codigo_reserva=" + codigo_reserva + ", precio_total="
